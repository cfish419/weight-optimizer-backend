...
class SyncRepository:
    ...
    def get_last_update(self, resource_id: str) -> Optional[Dict[str, Any]]:
        ...
        for update in self.updates_store.values():
            ...
            if (update_data.get("baggage_id") == resource_id or 
                update_data.get("flight_id") == resource_id):
    ...
    def resolve_conflict(self, conflict_id: str, resolution: str) -> bool:
        ...
        try:
            if conflict_id in self.conflicts:
                ...
                self.conflicts[conflict_id]["resolved_at"] = datetime.utcnow().isoformat()
                return True
            return False
        except Exception:
            return False
    ...
    def get_unresolved_conflicts(self, agent_id: str) -> List[Dict[str, Any]]:
        ...
        for conflict in self.conflicts.values():
            if (conflict["status"] == "unresolved" and 
                conflict["data"].get("agent_id") == agent_id):
