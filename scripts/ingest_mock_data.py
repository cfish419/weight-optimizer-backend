...
from src.db.models import Base, Flight, Baggage
...
def load_mock_data():
    ...
    try:
        ...
        for i, (flight_data, manifest) in enumerate(zip(data["flights"], data["manifests"])):
            ...
            print(f"Processed flight {flight_data['flight_number']} with {len(manifest['baggage'])} bags")
