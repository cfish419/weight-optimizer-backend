...
class FAA_Validator:
    ...
    @staticmethod
    def validate_weight_balance_compliance(
    ...
    @staticmethod
    def validate_cargo_compartment_limits(
        config: FlightConfiguration,
    ) -> Dict[str, bool]:
        ...
        return {
            ...
            "total_within_limits": (
                distribution["forward_cargo"] <= forward_limit
                and distribution["aft_cargo"] <= aft_limit
            ),
        }
