...
class WeightBalanceCalculator:
    ...
    def validate_weight_limits(config: FlightConfiguration) -> Dict[str, bool]:
        ...
        return {
            ...
            "mzfw_valid": (total_weight - config.fuel_weight)
            <= config.aircraft.max_zero_fuel_weight,
        }
