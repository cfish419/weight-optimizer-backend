# VPC Module for Weight Optimizer
# Creates a /24 VPC with public/private subnets, IGW, NAT Gateway, and Transit Gateway
...
# Transit Gateway (for future multi-VPC connectivity)
