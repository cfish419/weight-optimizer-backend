...
class ObservabilityService:
        ...
        def decorator(func):
            ...
            def wrapper(*args, **kwargs):
                ...
                try:
                    ...
                    # Log performance
                    self.log_business_event('performance', {
                    ...
                    # Send metric
                    self.put_metric(f'{operation_name}Latency', duration, 'Milliseconds')
    ...
    def trace_operation(self, operation_name: str, **context):
        ...
        self.log_business_event('operation_start', {
            'operation': operation_name,
            **context
        }, request_id)
        ...
        try:
            ...
            self.log_business_event('operation_complete', {
                'operation': operation_name,
                'duration_ms': duration,
                'status': 'success'
            }, request_id)
            ...
            self.log_business_event('operation_error', {
                'operation': operation_name,
                'duration_ms': duration,
                'error': str(e),
                'status': 'error'
    ...
    def track_business_metrics(self, fuel_savings: float, loading_time_reduction: float,
                             agent_count: int, request_id: Optional[str] = None):
