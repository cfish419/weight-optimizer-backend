...
class BaggageService:
    ...
    def add_baggage(self, baggage_data: Dict[str, Any]) -> str:
        ...
        baggage_item = BaggageItem(
            ...
            special_item_type=SpecialItemType(baggage_data['special_item_type']) if baggage_data.get('special_item_type') else None,
        ...
        if not validation_result['valid']:
            raise ValueError(f"Baggage validation failed: {validation_result['errors']}")
    ...
    def optimize_compartment_loading(self, flight_id: str) -> Dict[str, Any]:
        ...
        sorted_items = sorted(baggage_items, 
                            key=lambda x: BaggageItem(**x).get_loading_priority())
        ...
        for item_data in sorted_items:
            ...
            if forward_weight < 3400 and (item.weight > 20 or forward_weight <= aft_weight):
