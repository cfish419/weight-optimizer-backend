...
from src.models.weather import WeatherCondition, WeatherData
...
class WeatherService:
    ...
    def calculate_fuel_adjustment(
        self, weather: WeatherData, base_fuel: float
    ) -> float:
    ...
    def get_performance_limitations(self, weather: WeatherData) -> dict:
        ...
        limitations["max_takeoff_weight_reduction"] = (
            1.0 - perf_factor
        ) * 100  # percentage
