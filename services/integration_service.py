...
class IntegrationService:
    def __init__(self):
        self.legacy_systems = {
            "weight_balance": LegacySystemConfig(
                ...
                auth_type="basic",
                credentials={
                    "username": os.getenv("WB_USERNAME", "wb_user"),
                    "password": os.getenv("WB_PASSWORD", "wb_pass"),
                },
                protocol="rest",
            ),
            "dcs": LegacySystemConfig(
                ...
                auth_type="oauth",
                credentials={
                    "client_id": os.getenv("DCS_CLIENT_ID", "dcs_client"),
                    "client_secret": os.getenv("DCS_CLIENT_SECRET", "dcs_secret"),
                },
                protocol="soap",
            ),
            ...
            "fos": LegacySystemConfig(
                ...
                auth_type="basic",
                credentials={
                    "username": os.getenv("FOS_USERNAME", "fos_user"),
                    "password": os.getenv("FOS_PASSWORD", "fos_pass"),
                },
                protocol="rest",
            ),
        }

    async def sync_to_legacy_wb_system(
    ...
    async def bulk_sync_all_systems(
        self, flight_data: Dict[str, Any]
    ) -> Dict[str, Any]:
